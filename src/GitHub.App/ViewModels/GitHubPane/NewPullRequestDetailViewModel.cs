...
namespace GitHub.ViewModels.GitHubPane
{
    ...
    /// </summary>
    [Export(typeof(INewPullRequestDetailViewModel))]
    [PartCreationPolicy(CreationPolicy.NonShared)]
    public class NewPullRequestDetailViewModel : NewPanePageViewModelBase, INewPullRequestDetailViewModel
    {
        ...
        public NewPullRequestDetailViewModel(
