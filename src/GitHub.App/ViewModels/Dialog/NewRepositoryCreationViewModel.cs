...
{
    [Export(typeof(INewRepositoryCreationViewModel))]
    [PartCreationPolicy(CreationPolicy.NonShared)]
    public class NewRepositoryCreationViewModel : NewRepositoryFormViewModel, INewRepositoryCreationViewModel
    {
        ...
        public NewRepositoryCreationViewModel(
