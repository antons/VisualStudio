...
{
    [Export(typeof(INewRepositoryCloneViewModel))]
    [PartCreationPolicy(CreationPolicy.NonShared)]
    public class NewRepositoryCloneViewModel : NewViewModelBase, INewRepositoryCloneViewModel
    {
        ...
        public NewRepositoryCloneViewModel(
