...
{
    [Export(typeof(INewRepositoryPublishViewModel))]
    [PartCreationPolicy(CreationPolicy.NonShared)]
    public class NewRepositoryPublishViewModel : NewRepositoryFormViewModel, INewRepositoryPublishViewModel
    {
        ...
        public NewRepositoryPublishViewModel(
