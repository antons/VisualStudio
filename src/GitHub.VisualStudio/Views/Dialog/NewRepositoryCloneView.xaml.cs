...
{
    public class GenericNewRepositoryCloneView : NewViewBase<INewRepositoryCloneViewModel, NewRepositoryCloneView>
    {}

    /// <summary>
    /// Interaction logic for CloneRepoControl.xaml
    /// </summary>
    [ExportViewFor(typeof(INewRepositoryCloneViewModel))]
    [PartCreationPolicy(CreationPolicy.NonShared)]
    public partial class NewRepositoryCloneView : GenericNewRepositoryCloneView
    {
        ...
        {
            readonly NewRepositoryCloneView owner;

            public RepositoryGroupDescription(NewRepositoryCloneView owner)
            {
