...
{
    public class GenericNewRepositoryCreationView : NewViewBase<INewRepositoryCreationViewModel, NewRepositoryCreationView>
    { }

    /// <summary>
    /// Interaction logic for NewRepositoryCreationView.xaml
    /// </summary>
    [ExportViewFor(typeof(INewRepositoryCreationViewModel))]
    [PartCreationPolicy(CreationPolicy.NonShared)]
    public partial class NewRepositoryCreationView : GenericNewRepositoryCreationView
    {
        public NewRepositoryCreationView()
        {
            InitializeComponent();
