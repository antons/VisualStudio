...
using ReactiveUI;
using LoginMode = GitHub.ViewModels.Dialog.LoginMode;

namespace GitHub.VisualStudio.Views.Dialog
{
    public class GenericNewLoginView : NewViewBase<INewLoginViewModel, NewLoginView>
    { }
    ...
    public partial class NewLoginView : GenericNewLoginView
    {
        public NewLoginView()
        {
            InitializeComponent();
