...
{
    public class GenericNewPullRequestDetailView : NewViewBase<INewPullRequestDetailViewModel, GenericNewPullRequestDetailView>
    { }

    [ExportViewFor(typeof(INewPullRequestDetailViewModel))]
    [PartCreationPolicy(CreationPolicy.NonShared)]
    public partial class NewPullRequestDetailView : GenericNewPullRequestDetailView
    {
        public NewPullRequestDetailView()
        {
            InitializeComponent();
